...
class Reservation extends Component {
    ...
    render() {
        ...
        const onDateChange = (event, selectedDate) => {
            if(event.type=="set"){
                this.setState({date: selectedDate.toISOString(), showDatepicker:false});
            }
            else{
        ...
        return(
            <ScrollView>
                ...
                <View style={styles.formRow}>
                    ...
                    <FaIcon name="calendar" size={24} onPress={() =>this.setState({showDatepicker:true})} />     
                    <DatePicker/>
                </View>
                    ...
                    onPress={() => {
                            Alert.alert(
                                ...
                                [
                                    ...
                                    {
                                        text: 'OK',
                                        onPress: () => {this.handleReservation();this.presentLocalNotification(this.state.date);}
                                    }
                                ],
                                { cancelable: false }
                            );
